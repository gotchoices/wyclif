...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/wyatt.js");
/******/ })
/************************************************************************/
/******/ ({
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.config.productionTip = false; //import WylibApp from '../src/app.vue'
  ...
  data: function data() {
    return {
      ...
      tabs: [{
        ...
        component: 'tabEditor',
        title: 'Database',
        help: 'Direct access to database tables'
      }, {
        tag: 'ent',
        component: 'entEditor',
        title: 'Users',
        help: 'View and edit database user entities'
      }, {
        tag: 'erd',
        component: 'erdViewer',
        title: 'ERD',
        help: 'Graphical view of database tables and their relations'
      }]
    };
  },
  computed: {
    currentComp: function currentComp() {
      ...
      return this.tabs.find(function (e) {
        return e.tag == _this.state.curTab;
      }).component;
    }
...
/******/ });
//# sourceMappingURL=wyatt-bundle.js.map